...
To help drive and generate better business decisions, this web application was developed using Python programming language with the help of the Dash module. This application aims to aid the sales department in providing historic sales and profitability performance, and visualization of various aspects such as geographical sales performance monitoring and sales against profit by product category.
...
Using Dash callback Python declarators, the first data figure can be interacted with. A drop-down menu has been implemented, which parses in the variable to the Plotly graph, and the graph will be generated depending on the variable.
...
## Current Maintainer
[Sathvika Kalapala](https://www.linkedin.com/in/sathvika-kalapala-63271512a)
Email: sathvika.kalapala1211@gmail.com

## About the Maintainer

Sathvika Kalapala is a Data Analyst with over 3 years of experience in transforming raw data into actionable insights and automated pipelines. She specializes in developing decision-ready dashboards and is proficient in SQL, Python (Pandas/NumPy), and various visualization tools. Sathvika actively maintains and enhances projects like this one, focusing on delivering measurable impact and robust data solutions.